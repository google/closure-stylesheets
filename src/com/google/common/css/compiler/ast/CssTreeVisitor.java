...
public interface CssTreeVisitor extends AtRuleHandler {
  ...
  /** Called before visiting a {@code CssValueNode} that is a {@code CssCompositeValueNode} */
  @CheckReturnValue
  ...
  /** Called before visiting a {@code CssValueNode} that is not a {@code CssCompositeValueNode} */
  @CheckReturnValue
